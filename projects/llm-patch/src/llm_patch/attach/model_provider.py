...
class HFModelProvider(IModelProvider):
    ...
    def load(self, model_id: str, **kwargs: Any) -> ModelHandle:
        ...
        try:
            ...
            msg = (
                "HuggingFace runtime dependencies are unavailable. Install the llm-patch "
                "model runtime requirements and retry."
            )
        ...
        logger.info(
            "Loading base model %s (dtype=%s, device_map=%s)", model_id, dtype_str, device_map
        )
        ...
        try:
            ...
            msg = f"Failed to load base model '{model_id}'."
